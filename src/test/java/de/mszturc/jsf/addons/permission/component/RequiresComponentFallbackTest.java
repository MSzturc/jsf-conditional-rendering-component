...
public class RequiresComponentFallbackTest {
    ...
    @Test
    @RunAsClient
    public void permissionToViewMenu(@InitialPage TestPage page) throws Exception {
        
        assertEquals("Menu", page.getTitle());
        assertEquals("Administration", page.getMenu());
